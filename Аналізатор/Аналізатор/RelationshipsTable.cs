...
namespace Trance_4
{
    public static class RelationshipsTable
    {
        ...
        public static List<GrammarLine> GetGramarList()
        {
            ...
            gramarList.Add(new GrammarLine("~operlist", "~oper", "~operlist"));
            gramarList.Add(new GrammarLine("~operlist", "~ohol"));
            gramarList.Add(new GrammarLine("~operlist", "~ohol", "~operlist"));
            ...
            gramarList.Add(new GrammarLine("~log_vyr", "~log_dod1"));
